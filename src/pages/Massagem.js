        ...
        <div className="container" >
            ...
            <div className='center_all'>
                    ...
                    <div className='column_all'>
                            <strong className='simple_titulo center' style={{margin:'30px 0 30px 0', fontSize:'2.3em', fontWeight: 300}}> bdkjabdjaddnln </strong>
                    </div>
                    ...
                    <div className='column_all' style={{margin:'30px 0 10px 0'}}>
                        <div style={{width:'100%'}}>
                        <strong className='simple_titulo' style={{margin:'30px 0 30px 0', fontSize:'1.2em', fontWeight: 300}}> jasdbja ajsdhbadhn</strong>
                        </div>
                    </div>
