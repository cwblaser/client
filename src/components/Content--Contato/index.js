             ...
             <div id='contato-wrapper' style={{width:'80%',  ...sty, flexDirection:'column'}}>
                ...
                <div id='wrap-contato-formulario' style={{width:'100%',  ...sty}}>
                    <div id='c-contato' style={{width:'40%', ...sty, flexDirection:'column'}}>
                        <strong style={{width:'100%', margin: '20px 0 20px 0', color:'#a0f94e', fontSize:'1.4em'}}> Contatos </strong>
                        <span className='simple_text' style={{width:'100%', ...sty, justifyContent: 'flex-start', margin: '10px 0 10px 0'}}><HiOutlineLocationMarker /><p style={{marginLeft:'20px'}}>R. exemplo, 200 - Lisboa </p></span>
                        <span className='simple_text' style={{width:'100%', ...sty, justifyContent: 'flex-start', margin: '10px 0 10px 0'}}><AiOutlinePhone /><p style={{marginLeft:'20px'}}>(xx) 0 0000-000 </p></span>
                        <span className='simple_text' style={{width:'100%', ...sty, justifyContent: 'flex-start', margin: '10px 0 10px 0'}}><AiOutlineMail /><p style={{marginLeft:'20px'}}> exemplo@exemplo.com </p></span>
